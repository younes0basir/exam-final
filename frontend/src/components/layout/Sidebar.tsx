  ...
  return (
    <aside className="w-64 glass-card border-r border-cyan-500/20 flex flex-col">
      ...
      <div className="p-4 border-b border-gray-800">
        <h2 className="text-xs font-semibold text-gray-500 uppercase tracking-wider">{t('dashboard.quickActions')}</h2>
      </div>
      ...
      <div className="p-4 border-t border-gray-800">
        <div className="glass-card rounded-xl p-3 border border-cyan-500/10">
          <p className="text-xs text-gray-500 mb-1">{t('common.status')}</p>
          <div className="flex items-center gap-2">
            <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
            <span className="text-xs font-medium text-gray-400">{t('common.active')}</span>
          </div>
        </div>
      </div>
    </aside>
